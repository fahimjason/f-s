...
const showImages = (images) => {
  ...
  handlingSpinner('loading-spinner', 'd-none');
}
...
const showError = error => {
  const ShowError = document.getElementById('slider-numbers');
  ShowError.innerText = error;
}


// Spinner Handler
const handlingSpinner = (id, divSpinner) => {
  const displaySpinner = document.getElementById(id);
  displaySpinner.classList.toggle(divSpinner);
}
